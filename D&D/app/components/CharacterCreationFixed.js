...
import { ArrowLeft, Dice6, Sword, Shield, Wand2, Bow } from 'lucide-react'
...
const classes = [
  { id: 'warrior', name: 'Guerreiro', icon: Sword, description: 'Mestre em combate corpo a corpo' },
  { id: 'mage', name: 'Mago', icon: Wand2, description: 'Manipulador de magias ancestrais' },
  { id: 'ranger', name: 'Ranger', icon: Bow, description: 'Explorador hábil com arco' },
  { id: 'paladin', name: 'Paladino', icon: Shield, description: 'Protetor sagrado do reino' }
]
            ...
            <div className="p-6 space-y-8">
              ...
              {step === 2 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <button onClick={() => setStep(1)} className="flex-1 py-2 border border-gold/30 text-gold rounded hover:bg-gold/10 transition-all">
                      Voltar
                    </button>
                    <button
                      onClick={() => setStep(3)}
              ...
              {step === 3 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <button onClick={() => setStep(2)} className="flex-1 py-2 border border-gold/30 text-gold rounded hover:bg-gold/10 transition-all">
                      Voltar
                    </button>
                    <button
                      onClick={() => setStep(4)}
              ...
              {step === 4 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    <button onClick={() => setStep(3)} className="flex-1 py-2 border border-gold/30 text-gold rounded hover:bg-gold/10 transition-all">
                      Voltar
                    </button>
                    <button
